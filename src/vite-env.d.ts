...
interface ImportMetaEnv {
  /** Use the offline MockMirageSdk instead of the live testnet client. */
  ...
  readonly VITE_MIRAGE_POOL?: string
  ...
  /** MirageBridgeL1 escrow address on Sepolia (0x…). */
  readonly VITE_L1_BRIDGE_ADDRESS?: string
  /** Soroban EthLightClient contract id (C…). */
  readonly VITE_ETH_LIGHT_CLIENT?: string
  /** Soroban MirageBridge contract id (C…). */
  readonly VITE_MIRAGE_BRIDGE?: string
